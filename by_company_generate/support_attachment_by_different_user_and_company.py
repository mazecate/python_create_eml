...
data = {
    "CompanyA": [
        {"username": "Peter Chan", "goh": "Mr. John Lam", "to": ["recipient1@example.com"], "cc": ["cc1@example.com", "cc2@example.com"], "attachments": [f"{attachmentPath}attachment/dummy.pdf"]},
        {"username": "Alice Tan", "goh": "Mr. John Lam", "to": ["recipient2@example.com"], "cc": ["cc3@example.com"], "attachments": [f"{attachmentPath}attachment/dummy.pdf"]},
    ],
    "CompanyB": [
        {"username": "John Doe", "goh": "Mr. John Lam", "to": ["recipient3@example.com"], "cc": ["cc4@example.com", "cc5@example.com"], "attachments": [f"{attachmentPath}attachment/dummy.pdf"]},
        {"username": "Jane Smith", "goh": "Mr. John Lam", "to": ["recipient4@example.com"], "cc": ["cc6@example.com"], "attachments": [f"{attachmentPath}attachment/dummy.pdf"]},
    ]
}
